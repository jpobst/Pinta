...
/// <summary>
/// Utility methods for the Pinta.Foundation library.
/// </summary>
public static class FoundationUtility
{
	...
	internal static readonly uint[] MasTable =
	[
	...
	/// </summary>
	private static bool IsConstantRow (PixelBuffer surface, ColorBgra color, RectangleI rectangle, int y)
	{
	...
	/// </summary>
	private static bool IsConstantColumn (PixelBuffer surface, ColorBgra color, RectangleI rectangle, int x)
	{
	...
	public static RectangleI GetObjectBounds (PixelBuffer image, RectangleI? searchArea = null)
	{
