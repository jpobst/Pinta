...
namespace Pinta.ImageManipulation
{
	public unsafe abstract class PixelOp
	{
		...
		public void Apply (ISurface dst, ISurface src, Rectangle[] rois, int startIndex, int length)
		{
		...
		public void Apply (ISurface dst, Point dstOffset, ISurface src, Point srcOffset, Size roiSize)
		{
		...
		public void ApplyBase (ISurface dst, Point dstOffset, ISurface src, Point srcOffset, Size roiSize)
		{
		...
		public virtual void Apply (ISurface dst, Point dstOffset, ISurface src, Point srcOffset, int scanLength)
		{
